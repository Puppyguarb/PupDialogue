...
@export var next_icon := preload('res://addons/pup_dialogue/icons/Play.svg')
## Sample portrait image that is visible in editor. This will not show in-game.
@export var sample_portrait := preload('res://addons/pup_dialogue/icons/Portrait.png'): set = _set_sample_portrait
