...
@export var nodeScenes: Array[PackedScene] = [
	preload("res://addons/pup_dialogue/nodes/StartNode.tscn"),
	preload("res://addons/pup_dialogue/nodes/DialogueNode.tscn"),
	preload("res://addons/pup_dialogue/nodes/CommentNode.tscn"),
	preload("res://addons/pup_dialogue/nodes/SignalNode.tscn"),
	preload("res://addons/pup_dialogue/nodes/SetNode.tscn"),
	preload("res://addons/pup_dialogue/nodes/ConditionNode.tscn")
]
