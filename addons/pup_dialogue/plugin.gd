...
const EditorScene = preload('res://addons/pup_dialogue/NodeEditor.tscn')
const DialogueBoxScene = preload('res://addons/pup_dialogue/objects/dialogueBox.gd')
const DialogueBoxIcon = preload('res://addons/pup_dialogue/icons/PupDialogue.svg')
...
func _get_plugin_icon():
	return preload('res://addons/pup_dialogue/icons/PupDialogue.svg')
